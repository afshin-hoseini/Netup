...
public interface OnConnectionResultListener {
	...
	/**
	 * Will be raised while connection pkgDlStatus changed.<br/>
	 * 
	 * <h2>Note:</h2> While a cancellation has been took place, this method will be invoked with <i>ConnectionStatus.CANCELED</i>.<br/>
